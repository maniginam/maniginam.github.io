...
}catch (e7298){if((e7298 instanceof ttt.terminal.user_inputs.Exception)){
var e = e7298;
...
}catch (e7299){if((e7299 instanceof ttt.terminal.user_inputs.Exception)){
var e = e7299;
...
return cljs.core.int_QMARK_.call(null,(function (){try{return Integer.parseInt(input);
}catch (e7300){if((e7300 instanceof ttt.terminal.user_inputs.Exception)){
var e = e7300;
cljs.core.println.call(null,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(input)," is not a valid option"].join(''));
...
var G__7301 = ttt.terminal.user_inputs.ask_for_box.call(null);
input = G__7301;
continue;
}
break;
