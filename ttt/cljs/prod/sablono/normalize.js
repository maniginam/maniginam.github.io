...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.call(null,(function (p__7709){
var vec__7710 = p__7709;
var _ = cljs.core.nth.call(null,vec__7710,(0),null);
var v = cljs.core.nth.call(null,vec__7710,(1),null);
...
if(((((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$)))) && (cljs.core.every_QMARK_.call(null,(function (p1__7713_SHARP_){
return (((p1__7713_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__7713_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.call(null,G__7714,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__7714;
}
});
...
var len__4736__auto___7717 = arguments.length;
var i__4737__auto___7718 = (0);
while(true){
if((i__4737__auto___7718 < len__4736__auto___7717)){
args__4742__auto__.push((arguments[i__4737__auto___7718]));

var G__7719 = (i__4737__auto___7718 + (1));
i__4737__auto___7718 = G__7719;
continue;
} else {
}
break;
...
var G__7716 = cljs.core.reduce.call(null,cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_.call(null,classes)))){
return cljs.core.assoc.call(null,G__7716,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec.call(null,classes));
} else {
return G__7716;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq7715){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq7715));
}));
...
var tag_name = cljs.core.nth.call(null,vec__7722,(0),null);
var names = cljs.core.nth.call(null,vec__7722,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css.call(null,cljs.core.some.call(null,(function (p1__7720_SHARP_){
if(cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__7720_SHARP_))){
return p1__7720_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.comp.call(null,cljs.core.filter.call(null,(function (p1__7721_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__7721_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__7725){
var vec__7726 = p__7725;
var seq__7727 = cljs.core.seq.call(null,vec__7726);
var first__7728 = cljs.core.first.call(null,seq__7727);
var seq__7727__$1 = cljs.core.next.call(null,seq__7727);
var tag = first__7728;
var content = seq__7727__$1;
...
var vec__7729 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__7729,(0),null);
var id = cljs.core.nth.call(null,vec__7729,(1),null);
var class$ = cljs.core.nth.call(null,vec__7729,(2),null);
