...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.call(null,(function (p__7419){
var vec__7420 = p__7419;
var _ = cljs.core.nth.call(null,vec__7420,(0),null);
...
if(((((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$)))) && (cljs.core.every_QMARK_.call(null,(function (p1__7423_SHARP_){
return (((p1__7423_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__7423_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.call(null,G__7424,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__7424;
}
});
...
var len__4736__auto___7427 = arguments.length;
var i__4737__auto___7428 = (0);
while(true){
if((i__4737__auto___7428 < len__4736__auto___7427)){
args__4742__auto__.push((arguments[i__4737__auto___7428]));

var G__7429 = (i__4737__auto___7428 + (1));
i__4737__auto___7428 = G__7429;
continue;
} else {
}
break;
...
var G__7426 = cljs.core.reduce.call(null,cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_.call(null,classes)))){
return cljs.core.assoc.call(null,G__7426,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec.call(null,classes));
} else {
return G__7426;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq7425){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq7425));
}));
...
var tag_name = cljs.core.nth.call(null,vec__7432,(0),null);
var names = cljs.core.nth.call(null,vec__7432,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css.call(null,cljs.core.some.call(null,(function (p1__7430_SHARP_){
if(cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__7430_SHARP_))){
return p1__7430_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.comp.call(null,cljs.core.filter.call(null,(function (p1__7431_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__7431_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__7435){
var vec__7436 = p__7435;
var seq__7437 = cljs.core.seq.call(null,vec__7436);
var first__7438 = cljs.core.first.call(null,seq__7437);
var seq__7437__$1 = cljs.core.next.call(null,seq__7437);
var tag = first__7438;
var content = seq__7437__$1;
...
var vec__7439 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__7439,(0),null);
var id = cljs.core.nth.call(null,vec__7439,(1),null);
var class$ = cljs.core.nth.call(null,vec__7439,(2),null);
