...
*   Find the shell you’re using:			*echo $SHELL*
    ![Mac JAVA_HOME](https://maniginam.github.io/article/images/images/macJavaHome.png)  
...
*   You've now opened vim, which allows you to edit documents within the terminal
    ...
    *   Copy/Paste:     *export JAVA_HOME=/usr/libexec/java_home -v {{enter version i.e. 1.8}}*
        ![vim export JAVA_HOME](https://maniginam.github.io/article/images/images/exportJavaHomeVIM.png)  
    *   Push esc, then type:					*:wq*
        ![Mac vim :wq](https://maniginam.github.io/article/images/images/vim:wq.png)  
...
![win JAVA_HOME](/https://maniginam.github.io/article/images/images/winJavaHome.png)  
...
*   Start the REPL:     *lein repl*
    ![REPL](https://maniginam.github.io/article/images/images/repl.png)  
...
*   Try something like this: 			*(+ 3 3)*
    *   Did it return 6?
        ![repl (+ 3 3)](https://maniginam.github.io/article/images/images/replSix.png) 
*   Now try this:  					*(def hello “Hello, World!”)* 
*   and now: 			            *hello*
    ![Hello, World!](https://maniginam.github.io/article/images/images/helloWorld.png)  
*   Let’s write a function:  			*(defn hello [name] “Hello, ” name “!”)*
*   Call your function: 				*(hello “Gina”)*
    ![Hello, Gina!](https://maniginam.github.io/article/images/images/helloGina.png)  
*   Set your name:  				    *(def my-name “Gina”)*
*   Call your function again with my-name:  	*(hello my-name)*
    ![Hello, My Name!](https://maniginam.github.io/article/images/images/hello-my-name.png)
...
![Fork](/https://maniginam.github.io/article/images/images/forkIt!.png)  
...
*   Change into it:							            *cd projects*
    ![mkdir & cd projects](/https://maniginam.github.io/article/images/images/macdProjects.png)
